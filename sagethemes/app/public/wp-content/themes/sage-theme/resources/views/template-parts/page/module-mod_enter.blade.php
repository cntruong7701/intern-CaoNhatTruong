<section class="max-w-[1114px] mx-[auto]">
    ...
    <div class="flex max-w-3/4 justify-around">
        <img src="{!! App::getIcon()['icon1'] !!}" class="ml-25" alt="{!! App::getIcon()['alt'] !!}">
        <img src="{!! App::getIcon()['icon2'] !!}" class="" alt="{!! App::getIcon()['alt'] !!}">
        <img src="{!! App::getIcon()['icon3'] !!}" class="" alt="{!! App::getIcon()['alt'] !!}">
        <img src="{!! App::getIcon()['icon2'] !!}" class="" alt="{!! App::getIcon()['alt'] !!}">
        <img src="{!! App::getIcon()['icon4'] !!}" class="mr-25" alt="{!! App::getIcon()['alt'] !!}">
    </div>
